...
public class KeytermExtractor extends AbstractKeytermExtractor {
	...
	public void initialize(UimaContext aContext)
		...
		try {
			...
			String hmmpath = this.getClass().getClassLoader()
					.getResource("model/ne-en-bio-genetag.hmmchunker")
					.getPath();
			String tokenpath = this.getClass().getClassLoader()
