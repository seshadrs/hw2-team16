 ...
 * 
 */
public class GoldenKeytermExtractor extends AbstractKeytermExtractor {
  ...
  protected List<Keyterm> getKeyterms(String question) {
    ...
    List<String> goldenKeyterms = GoldenKeytermsProvider.getGoldenKeyterms(question);
    for (String keyterm : goldenKeyterms) {
      keyterms.add(new Keyterm(keyterm));
    }
    /*
